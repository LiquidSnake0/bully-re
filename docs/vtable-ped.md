...
| 44 | 00477530 | 0049a6a0 | `ProcessTroubleDecay()` ? : décrémente +0x1d40 avec le temps (0xc1a9b4), parcourt le pool de piétons ; le joueur appelle la base puis plafonne +0x1d40 par le bas avec +0x1ebc | ? |
| 45 | 00477480 | hérité | `AddTrouble(int amount)` ? : ignore cinq modèles réservés, joue un son (0x458330, id 0x9a) pour le joueur, ajoute à +0x1d40 borné à 0, puis 0x4773d0 | ? |
...
| +0x1d40 | jauge qui décroît avec le temps (ennuis / recherche ?) |
| +0x1d48 | dernier tick de décroissance |
| +0x1ebc | plancher de la jauge (CPlayerPed) |
