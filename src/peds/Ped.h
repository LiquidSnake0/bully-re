...
public:
	...
	virtual void ProcessTroubleDecay(void);                      // 0x477530, nom ?
	virtual void AddTrouble(int32 amount);                       // 0x477480, nom ?

	int32 m_nPedState;            // +0x1310
	uint32 m_field1d2c;           // +0x1d2c
	int32 m_nTrouble;             // +0x1d40, nom ?
	uint32 m_nTroubleLastTick;    // +0x1d48
	...
	void OnSmallTrouble(void);                  // 0x474480, nom ?
